/*
	...
	Check out the (https://www.hackerrank.com/challenges/30-operators/tutorial) for learning materials and an
	instructional video.
	
	Task:
	Given the meal price (base cost of a meal), tip percent (the percentage of the meal price being added as 
	tip), and tax percent (the percentage of the meal price being added as tax) for a meal, find and print 
